...
local LowItems = {{name = "watch", label = "Watch"}, {name = "iron", label = "Iron"}, {name = "phone", label = "Phone"}, {name = "chocolate", label = "Chocolate"}, {name = "cigarett", label = "Cigarett"}, {name = "clothe", label = "Clothe"}, {name = "cupcake", label = "Cupcake"}, {name = "lighter", label = "Lighter"}, {name = "rose", label = "Rose"}, {name = "umbrella", label = "Umbrella"}}
local MedItems = {{name = "ring", label = "Ring"}, {name = "watch", label = "Watch"}, {name = "gold", label = "Gold"}, {name = "phone", label = "Phone"}, {name = "champagne", label = "Champagne"}, {name = "clothe", label = "Clothe"}, {name = "cupcake", label = "Cupcake"}, {name = "rose", label = "Rose"}, {name = "umbrella", label = "Umbrella"}, {name = "wine", label = "Wine"}}
local HighItems = {{name = "jewels", label = "Jewels"}, {name = "ring", label = "Ring"}, {name = "gold", label = "Gold"}, {name = "diamond", label = "Diamond"}, {name = "champagne", label = "Champagne"}, {name = "clothe", label = "Clothe"}, {name = "rose", label = "Rose"}, {name = "umbrella", label = "Umbrella"}, {name = "whisky", label = "Whisky"}}
